...
| 상업용 실제 브라우저 게이트 | `pnpm check:visual-surface` | 390px, 430px, 768px, 1440px에서 홈·상세·영상·탐색·제보 20개 상태가 통과. 대시보드 숫자판 visible 0, forbidden 0, 하단 내비 겹침 0, 지도 시트 과밀 없음. 결과에는 `serviceStates`와 서비스 배너 상태도 포함 |
