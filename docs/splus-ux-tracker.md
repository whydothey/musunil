...
| 6 | 상업용 S+ 검증 | 390/430/768/1440px 캡처와 사용자 수락 전까지 S+ 표기를 금지한다. | 진행 중 · `pnpm check:visual-surface`가 실제 브라우저에서 20개 화면 상태를 검사 |
