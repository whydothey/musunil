...
Last checked: 2026-07-12T05:40:59.922Z
...
| web_forbidden_ui_absent | ok | {"bytes":389938,"tokenCount":22} |
| web_visual_surface | fail | Visual surface smoke failed: serviceStates=delayed ; homeSummaries=mobile_390_home:issues=3 stories=3 state=delayed banner=저장된 공개자료 기준 first=정보통신망법 개정 관련 집회 empty=missing emptyTitle=none emptyBody=none emptyActions= ; mobile_430_home:issues=3 stories=3 state=delayed banner=저장된 공개자료 기준 first=정보통신망법 개정 관련 집회 empty=missing emptyTitle=none emptyBody=none emptyActions= ; tablet_768_home:issues=3 stories=3 state=delayed banner=저장된 공개자료 기준 first=정보통신망법 개정 관련 집회 empty=missing emptyTitle=none emptyBody=none emptyActions= ; desktop_1440_home:issues=3 stories=3 state=delayed banner=저장된 공개자료 기준 first=정보통신망법 개정 관련 집회 empty=missing emptyTitle=none emptyBody=none emptyActions= ; failures=tablet_768_reels: reels evidence action missing:  \| tablet_768_reels: reels location action missing: |
