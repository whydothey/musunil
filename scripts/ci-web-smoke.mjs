...
async function checkWeb(port) {
  ...
  assert(index.includes('issueCardActionButton("map", "icon-locate", "지도"'), "issue card map action label missing");
  assert(index.includes('issueCardActionButton("video", "icon-video", "영상"'), "issue card video action label missing");
  ...
  assert(index.includes("issueVideoReviewText(issue)"), "compact field-video status helper missing");
