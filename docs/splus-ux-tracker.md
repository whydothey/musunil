...
| 상업용 재설계 63차 모바일 홈 미니맵 | `docs/commercial-splus-surface63-minimap-home-mobile-390-2026-07-12.png` | 홈 카드 우측 추상 타깃 장식을 자료 위치 미니맵으로 교체. 390px CDP `scrollWidth=390`, `placePeekCount=5`, `miniMapCount=5`, `areaCount=5` |
| 상업용 재설계 63차 데스크톱 홈 미니맵 | `docs/commercial-splus-surface63-minimap-home-desktop-1440-2026-07-12.png` | 데스크톱 홈 카드도 같은 미니맵 표면을 사용. 1440px CDP `scrollWidth=1440`, `placePeekCount=5`, `miniMapCount=5`, `areaCount=5` |
