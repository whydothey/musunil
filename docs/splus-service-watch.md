...
Last checked: 2026-07-12T00:21:22.405Z

Status: Active

| Check | Result | Detail |
|---|---|---|
| web_static_manifest | ok | {"files":5,"bytes":905705,"headersFile":"verified","mode":"matches_local_and_live_hashes"} |
...
| web_forbidden_ui_absent | ok | {"bytes":386907} |
| web_visual_surface | fail | Visual surface smoke failed: serviceStates=delayed ; homeSummaries=mobile_390_home:issues=0 stories=0 state=delayed banner=저장된 공개자료 기준 first=none empty=controlled emptyTitle=새 이슈를 확인 중입니다 emptyBody=공개 가능한 이슈가 아직 도착하지 않았습니다. 다시 확인하거나 지역별 현장 맥락을 먼저 볼 수 있습니다. emptyActions=다시 확인/지역 보기 ; mobile_430_home:issues=0 stories=0 state=delayed banner=저장된 공개자료 기준 first=none empty=controlled emptyTitle=새 이슈를 확인 중입니다 emptyBody=공개 가능한 이슈가 아직 도착하지 않았습니다. 다시 확인하거나 지역별 현장 맥락을 먼저 볼 수 있습니다. emptyActions=다시 확인/지역 보기 ; tablet_768_home:issues=0 stories=0 state=delayed banner=저장된 공개자료 기준 first=none empty=controlled emptyTitle=새 이슈를 확인 중입니다 emptyBody=공개 가능한 이슈가 아직 도착하지 않았습니다. 다시 확인하거나 지역별 현장 맥락을 먼저 볼 수 있습니다. emptyActions=다시 확인/지역 보기 ; desktop_1440_home:issues=0 stories=0 state=delayed banner=저장된 공개자료 기준 first=none empty=controlled emptyTitle=새 이슈를 확인 중입니다 emptyBody=공개 가능한 이슈가 아직 도착하지 않았습니다. 다시 확인하거나 지역별 현장 맥락을 먼저 볼 수 있습니다. emptyActions=다시 확인/지역 보기 ; failures=mobile_390_home: home issue feed not ready: issues=0, stories=0, state=delayed, banner=저장된 공개자료 기준, first=none, empty=controlled, emptyTitle=새 이슈를 확인 중입니다, emptyBody=공개 가능한 이슈가 아직 도착하지 않았습니다. 다시 확인하거나 지역별 현장 맥락을 먼저 볼 수 있습니다., emptyActions=다시 확인/지역 보기 \| mobile_390_home: expected at least 3 issue story rings, got 0 \| mobile_390_home: expected at least 3 issue cards, got 0 \| mobile_390_home: first issue title is missing \| mobile_390_home: first issue where/time/source line missing:  \| mobile_390_home: first issue evidence line missing fixed summary units:  \| mobile_390_home: first issue primary path missing:  \| mobile_390_home: first issue has too many visible action labels: 0 \| mobile_390_home: first issue must have exactly one primary action, got 0 \| mobile_430_home: home issue feed not ready: issues=0, stories=0, state=delayed, banner=저장된 공개자료 기준, first=none, empty=controlled, emptyTitle=새 이슈를 확인 중입니다, emptyBody=공개 가능한 이슈가 아직 도착하지 않았습니다. 다시 확인하거나 지역별 현장 맥락을 먼저 볼 수 있습니다., emptyActions=다시 확인/지역 보기 \| mobile_430_home: expected at least 3 issue story rings, got 0 \| mobile_430_home: expected at least 3 issue cards, got 0 \| +24 more |
...
|---|---|---|---|---|
| connect_api_endpoint | operator | pnpm render:api-settings와 pnpm cloudflare:dns 출력대로 Render musunil-api 설정과 환경변수를 확인한다. Custom Domains에 api.musunil.com을 추가하고, Render가 표시한 target을 Cloudflare DNS의 api 레코드에 DNS only로 연결한다. | pnpm render:api-settings && pnpm cloudflare:dns && pnpm cloudflare:check && pnpm launch:final-gate | docs/launch-cutover-runbook.md#3-render-api |
