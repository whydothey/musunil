...
const pages = {
  methodology: {
    ...
    icon: FileCheck2,
    sections: [
      ["주장과 근거 분리", "경찰·정부·언론·주최 측·시민·자동 분석이 전한 내용을 각각의 주장으로 기록합니다. 누가 말했는지, 무엇이 근거인지, 공개 위험이 어떤지는 하나의 신뢰 점수로 합치지 않습니다."],
      ["주제 종합", "동일 이름 법안 그룹을 우산 주제로 삼고, 최근 공개 근거에서 반복 확인되는 세부 논점만 표시합니다. 주제는 탐색 단위이며 사실 확정이나 찬반 판단이 아닙니다."],
      ["일정 연결", "시간과 장소만 담긴 경찰 일정은 주제와 자동 연결하지 않습니다. 해당 일정의 공개 주장과 확인 자료가 목적을 뒷받침할 때만 승인된 연결을 공개합니다."],
  ...
  privacy: {
    ...
    sections: [
      ...
      ["사용자 원문", "시민 제보와 신고 원문은 공개 기본값이 아닙니다. 공개 화면에는 비식별 처리하고 중립화한 요약만 표시합니다."]
    ]
  },
  rights: {
    eyebrow: "정정·반론·권리침해",
